...
proc processSwitch*(switch, arg: string, pass: TCmdLinePass, info: TLineInfo;
  ...
  of "verbosity":
    ...
    echo "<<< VERBOSITY. verbosity = " & $conf.verbosity & "verb = " & $verb & ", conf.notes = " & $conf.notes & ", conf.modifiedyNotes = " & $conf.modifiedyNotes
    echo "<<< VERBOSITY. computedVerbosityNotes" & $NotesVerbosity
    echo "<<< VERBOSITY. range: low = " & $low(TNoteKind) & ", high = " & $high(TNoteKind)
